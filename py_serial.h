...

{
...

    {
        ...
        error = gpio_set_intr_type(self->rxPin, (self->invert) ? GPIO_INTR_POSEDGE : GPIO_INTR_NEGEDGE);
        // printf("error = %d\n", error);

        // error = gpio_install_isr_service(0); // see machine_pin.c
        // printf("error = %d\n", error);
...

    {
        ...
        // gpio_uninstall_isr_service(); // see machine_pin.c
        // printf("error = %d\n", error);
